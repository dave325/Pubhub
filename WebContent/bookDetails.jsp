...
<!-- 	Just some stuff you need -->
	...
	%>
		...
		<form action="UpdateBookTags" method="post" class="form-horizontal">
		 <input type="hidden" class="form-control" id="isbn13" name="isbn13" required="required" value="${book.isbn13 }" />
		  <div class="form-group">
		    <label for="tags" class="col-sm-4 control-label">Tags (Seperated by a comma)</label>
		    <div class="col-sm-5">
		      <input type="text" class="form-control" id="booktags" name="booktags" placeholder="Tags" required="required" value="" />
		    </div>
		  </div>
		  <div class="form-group">
		    <div class="col-sm-offset-4 col-sm-1">
		...
		<form action="DeleteBookTags" method="post" class="form-horizontal">
		  ...
		  <div class="form-group">
		    <label for="tags" class="col-sm-4 control-label">Tags to Delete (Seperated by a comma)</label>
		    <div class="col-sm-5">
		      <input type="text" class="form-control" id="tags" name="booktags" placeholder="Tags" required="required" value="${tags.tags }" />
		    </div>
		  </div>
		  <div class="form-group">
		    <div class="col-sm-offset-4 col-sm-1">
