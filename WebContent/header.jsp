				...
				<c:choose>
					<c:when test="${not empty activeAccount }">
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown"><c:out value="${activeAccount}" /><b
								class="caret"></b></a>
							<ul class="dropdown-menu">
								<li><a href="LogoutAccount">Logout</a></li>
								<li class="divider"></li>
								<li><a href="OrderHistory">View Books</a></li>
							</ul></li>
					</c:when>
				</c:choose>
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						...
						<li class="divider"></li>
						<li><a href="BookTagDetails.jsp">Search by tags</a></li>
						<li><c:out value="${activeAccount} " /></li>
					</ul></li>
				<li class="dropdown"><a href="#" class="dropdown-toggle"
